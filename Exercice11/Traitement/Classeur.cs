...
namespace Traitement
{
    public class Classeur
    {
        ...
        public Dossier Creer(string nom, IList<string> nomFichiers)
        {
            ...
            var fichiers = nomFichiers.Select(x => new Fichier { Nom = x, DateCreation = DateTime.Now }).ToList();

            var result = new Dossier { Nom = nom, Fichiers = fichiers, DateCreation = DateTime.Now };
